...
export class ActionsService {
  ...
  public bindToAction(action: Action): Observable<{
    ...
    source?: ComponentNameType|[ComponentNameType,string]
  } | undefined> | undefined {
  ...
  public triggerAction(effect: Effect, data?: any, target?: EventTarget, source?: ComponentNameType|[ComponentNameType,string]): void {
