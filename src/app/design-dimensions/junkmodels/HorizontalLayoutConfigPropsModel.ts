...
import {MainAxisHorizontalPositioningConfigType} from "../../enums/HorizontalRowLayoutConfigTypes.enum";
...
import {WidthConfigModel} from "../Dimensioning/WidthConfigModel";
...
export class HorizontalLayoutConfigPropsModel {
  constructor(
    ...
    public width: WidthConfigModel|WidthValueConfigType.NA|WidthValueConfigType.NC,
  ...
  public getComponentProperties(propName: string, verticalLayout: VerticalLayoutConfigPropsModel): {parent?:any[][],children?:any[][]} {
    switch (propName) {
      ...
      case 'width':
        ...
        if ((this.width instanceof WidthConfigModel
            && this.width.dynamic instanceof DynamicDimensioningConfigModel
            && this.width.dynamic.stretch===true)
          || (verticalLayout.height instanceof HeightConfigModel
        ...
        if(verticalLayout.height instanceof HeightConfigModel && verticalLayout.height.fixed instanceof FixedDimensioningConfigModel){
        ...
        if(verticalLayout.height instanceof HeightConfigModel
